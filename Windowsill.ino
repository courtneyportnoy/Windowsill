...
void httpRequest() {
  ...
  if (client.connect(server, 80)) {
    ...
    client.println("GET /windowsill/getHours.php HTTP/1.1");
    client.println("Host: courtney-mitchell.com");
    client.println("User-Agent: arduino-ethernet");
    client.println("Connection: close");
    client.println();
    //client.print("Content-Length: ");
    //client.println(fileLength);  // get this from the SD card
...
void sendPicture() {
  ...
  if (myFile) {
    ...
    Serial.println("error opening IMAGE00.JPG");
  }
